...
function displayFiles(){
    display_file('field_5_1_science','file_5_1_science');
    display_file('field_5_1_thai','file_5_1_thai');
    display_file('field_5_1_english','file_5_1_english');
    display_file('field_5_1_social','file_5_1_social');
    display_file('field_5_1_biology','file_5_1_biology');
    display_file('field_5_1_chemist','file_5_1_chemist');
    display_file('field_5_1_physic','file_5_1_physic');
    display_file('field_5_2_science','file_5_2_science');
    display_file('field_5_2_thai','file_5_2_thai');
    display_file('field_5_2_english','file_5_2_english');
    display_file('field_5_2_social','file_5_2_social');
    display_file('field_5_2_biology','file_5_2_biology');
    display_file('field_5_2_chemist','file_5_2_chemist');
    display_file('field_5_2_physic','file_5_2_physic');
}
